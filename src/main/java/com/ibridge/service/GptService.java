...
public class GptService {
        ...
        try {
            ...
            JSONObject systemMessage = new JSONObject()
                    ...
                    .put("content", """
                            ...
                            아이의 발화가 질문이 아닐 경우 → 공감하는 말 하나와 후속 질문 하나만 만들어야 해.
                            아이의 발화가 질문일 경우 → 아이의 질문에 친근하게 대답하고, 이어서 후속 질문 하나를 만들어야 해.
                            공감과 질문, 혹은 대답과 질문 외에는 어떤 말도 하지 마.
                            항상 친근하고 간단하게 말하고, 줄바꿈 없이 한 문장으로 이어서 답해.
                            지난 대화와 같은 내용을 물어보거나 같은 내용을 답 하지마.
                        """);
    ...
    public Map<String, List<Long>> categorizeSubjects(List<Subject> subjects) {
        ...
        카테고리 이름은 한 단어로 GPT가 자유롭게 생성하되, 반드시 JSON 형식으로만 출력해야 합니다.
